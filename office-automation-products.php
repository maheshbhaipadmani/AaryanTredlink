    ...
    <div class="container relative z-index-1000">
        <div class="row g-4 gx-5 align-items-center">
            <div class="col-lg-6 offset-lg-3 text-center">
                ...
                <h1>Office Automation Products & Solutions</h1>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="owl-custom-nav menu-float px-5" data-target="#img-carousel">
                            ...
                            <div id="img-carousel" class="owl-carousel owl-theme owl-4-margin-15">
                                ...
                                <div class="item">
                                    <a href="images/product/office-automation-solution/cctv.avif"
                                        class="image-popup d-block hover">
                                        <div class="relative overflow-hidden rounded-10">
                                            <div
                                                class="absolute start-0 w-100 abs-middle fs-36 text-white text-center z-2">
            ...
            <div class="col-lg-6">
                ...
                <a href="it-products" class="btn-main mt-2 wow fadeInUp animated animation-air-condition-product" data-wow-delay=".7s" href="it-products">Our
                    Services</a>
            </div>
        </div>
    </div>
