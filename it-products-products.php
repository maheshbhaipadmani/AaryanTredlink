    ...
    <div class="container relative z-index-1000">
        <div class="row g-4 gx-5 align-items-center">
            <div class="col-lg-6 offset-lg-3 text-center">
                <div class="subtitle s2 bg-color text-light wow fadeInUp mb-2">Smart Solutions, Smooth
                    Operations</div>
                <h1>IT Products & Solutions</h1>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="owl-custom-nav menu-float px-5" data-target="#img-carousel">
                            ...
                            <div id="img-carousel" class="owl-carousel owl-theme owl-4-margin-15">
                                ...
                                <div class="item">
                                    <a href="images/product/it-product/Uninterruptible-Power-Supply.avif"
                ...
                <div class="accordion s2">
                    <div class="accordion-section">
                        ...
                        <div class="accordion-section-content" id="accordion-a1">
                            <ul class="ul-style-2">
                                <li>Processor Options: Intel Core i3/i5/i7/i9, AMD Ryzen Series</li>
                                <li>Memory (RAM): 4GB / 8GB / 16GB / 32GB (Expandable)</li>
                                <li>Storage Options: HDD (500GB/1TB), SSD (256GB/512GB/1TB)</li>
                                <li>Graphics: Integrated / Dedicated GPU (NVIDIA, AMD)</li>
                            </ul>
                        </div>
                        ...
                        <div class="accordion-section-content" id="accordion-a2">
                            <ul class="ul-style-2">
                                <li>UPS & Power Backup: Reliable solutions for uninterrupted operations</li>
                                <li>Energy Efficiency: Optimized power consumption for better performance
                                </li>
                        ...
                        <div class="accordion-section-content" id="accordion-a3">
                            <ul class="ul-style-2">
                                <li>Networking Solutions: High-speed LAN & Wi-Fi 6 support</li>
                                <li>Data Cabling: Secure and structured cabling solutions</li>
                                <li>Ports & Expansion: USB 2.0 / 3.0 / Type-C, HDMI, DisplayPort, RJ45</li>
                                <li>Bluetooth: Latest Version Support</li>
                            </ul>
                        </div>
                        ...
                        <div class="accordion-section-content" id="accordion-a4">
                            <ul class="ul-style-2">
                                <li>Device Options: Laptops, Desktops, Servers</li>
                                <li>Compact & Durable: Built for performance and longevity
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="accordion-section-content" id="accordion-a5">
                            <ul class="ul-style-2">
                                <li>IT Peripherals: HDDs, RAM, Printers, Keyboards, and more</li>
                                <li>Security: Secure Boot, TPM Chip, Advanced Encryption </li>
                                <li>OS Compatibility: Windows, macOS, Linux</li>
                                <li>Warranty & Support: Standard and extended coverage available</li>
                                <li>Consumables: Compatible cartridges and printing solutions</li>
                            </ul>
                        </div>
                    </div>
                </div>
