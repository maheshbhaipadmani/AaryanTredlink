...
?>
                ...
                <div class="container relative z-index-1000">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <h1>IT Products Repair</h1>
                            <ul class="crumb">
                                <li><a href="Home">Home</a></li>
                                <li class="active">IT Products Repair</li>
                            </ul>
                        </div>
                        <div class="col-lg-6 text-lg-end">
                            <div class="fs-20 fw-600 no-bottom sm-hide"> Expert IT Product Repairs – Fast & Reliable</div>
                        </div>
                    </div>
                </div>
            ...
            <section>
                <div class="container">
                    <div class="row g-5">
                        <div class="col-lg-3">
                            <a href="It-Products" class="bg-color-2 text-light d-block p-3 px-4 rounded-10px mb-3 relative"><h4 class="mb-0">About Us</h4><i class="icofont-long-arrow-right absolute abs-middle fs-24 end-20px"></i></a>
                            <a href="It-Products-Repair" class="bg-color-3 d-block p-3 px-4 rounded-10px mb-3"><h4 class="mb-0">Repair</h4></a>
                            <a href="It-Products-Maintenance" class="bg-color-3 d-block p-3 px-4 rounded-10px mb-3"><h4 class="mb-0">Maintenance</h4></a>
                        </div>

                        <div class="col-lg-9">
                            <h2>Facing IT Hardware <span class="id-color-2">Issues?</span> We've Got You Covered!</h2>

                            <div class="row">
                                <div class="col-lg-6">
                                    <ol class="ol-style-1">
                                        <li>System Lagging or Slow Performance</li>
                                        <li>Hardware Failures & Malfunctions</li>
                                        <li>Network Connectivity Issues</li>
                                        <li>Data Storage & Backup Failures</li>
                                        <li>Power Supply Problems</li>
                                        <li>Peripheral Device Malfunctions</li>
                                        <li>Software & Driver Compatibility Issues</li>
                                        <li>Overheating & Cooling System Failures</li>
                                        <li>Security & Firewall Troubles</li>
                                    ...
                                    <div class="padding50 sm-padding40 rounded-30 bg-color h-100 text-light">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <h3 class="mb20 wow fadeInUp" data-wow-delay=".2s">"Their customer service was exceptional. I highly recommend them to anyone in need of AC maintenance or repairs."</h3>
                                                Rachael Bellusci
                                            </div>
                                        </div>
                                    </div>
