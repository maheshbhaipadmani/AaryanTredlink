        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <ul class="crumb">
                    ...
                    <li class="active">Office Automation</li>
                </ul>
            </div>
            <div class="col-lg-6 text-lg-end">
                <div class="fs-20 fw-600 no-bottom sm-hide">Streamline Your Workplace with Smart Automation</div>
            </div>
        </div>
    </div>
...
<section>
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-3">
                <a href="Office-Automation" class="bg-color-2 text-light d-block p-3 px-4 rounded-10px mb-3 relative">
                    <h4 class="mb-0">About Us</h4><i
                        class="icofont-long-arrow-right absolute abs-middle fs-24 end-20px"></i>
                </a>
                <a href="Office-Automation-Repair" class="bg-color-3 d-block p-3 px-4 rounded-10px mb-3">
                    <h4 class="mb-0">Repair</h4>
                </a>
                <a href="Office-Automation-Maintenance" class="bg-color-3 d-block p-3 px-4 rounded-10px mb-3">
