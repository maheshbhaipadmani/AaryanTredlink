                                ...
                                <div class="row gx-5 align-items-center">
                                    ...
                                    <div class="col-lg-8 offset-lg-2 text-center">
                                        ...
                                        <div class="sw-text-wrapper">
                                            <div class="subtitle s2 mb-2">Efficient Refrigeration</div>
                                            <h2 class="slider-title mb-3">Efficient Cooling for Every Space
                                            </h2>
                                            <h3 class="slider-teaser mb-3">Top AC brands with expert
                                                installation & service.</h3>
                                            <div class="spacer-10"></div>
                                            <a href="contact" class="btn-main mb10 mb-3" >Send Inquiry</a>
                                        </div>
                                    </div>
                            ...
                            <div class="container">
                                <div class="row gx-5 align-items-center">
                                    ...
                                    <div class="col-lg-8 offset-lg-2 text-center">
                                        <div class="spacer-single"></div>
                                        <div class="sw-text-wrapper">
                                            <div class="subtitle s2 mb-2">Cooling & Comfort</div>
                                            <h2 class="slider-title mb-3">Reliable Refrigeration, Maximum
                                                Efficiency</h2>
                            ...
                            <div class="container">
                                <div class="row gx-5 align-items-center">
                                    ...
                                    <div class="col-lg-8 offset-lg-2 text-center">
                                        <div class="spacer-single"></div>
                                        <div class="sw-text-wrapper">
                                            <div class="subtitle s2 mb-2">Advanced IT Solutions</div>
                                            <h2 class="slider-title mb-3">Smart IT Solutions for a Digital
                                                World</h2>
...
<section class="pt50">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 faq-img-wid">
            ...
            <div class="col-lg-5 offset-lg-1">
                ...
                <div class="spacer-10"></div>
                <a href="about" class="btn-main wow fadeInUp" >Learn More</a>
            </div>
        </div>
...
<section class="bg-color text-light section-dark jarallax">
    <div class="container">
        ...
        <div class="col-lg-12">
            <div class="row g-4 arrow-divider light">
                <div class="col-lg-3 col-6 wow fadeInRight" data-wow-delay=".6s">
                    <div class="col-12 text-center">
                        <div class="bg-color text-light px-4 pt30 pb10 rounded-10 wow fadeInLeft">
                            <div class="de_count">
                                <h3><span class="timer" data-to="150" data-speed="3000"></span>+</h3>
                ...
                <div class="col-lg-3 col-6 wow fadeInRight" data-wow-delay=".6s">
                    <div class="col-12 text-center">
                        <div class="bg-color px-4 pt30 pb10 rounded-10 wow fadeInRight">
                            <div class="de_count">
                ...
                <div class="col-lg-3 col-6 wow fadeInRight" data-wow-delay=".6s">
                    <div class="col-12 text-center">
                        <div class="bg-color text-light px-4 pt30 pb10 rounded-10 wow fadeInLeft">
                            <div class="de_count">
                                <h3><span class="timer" data-to="2" data-speed="3000"></span>+</h3>
                                <h4>Locations of Operation</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-6 wow fadeInRight" data-wow-delay=".6s">
                    <div class="col-12 text-center">
                        <div class="bg-color px-4 pt30 pb10 rounded-10 wow fadeInRight">
                            <div class="de_count">
                                <h3><span class="timer" data-to="10" data-speed="3000"></span>+</h3>
                                <h4>Awards</h4>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInRight" data-wow-delay=".2s">
                <div class="rounded-20px overflow-hidden">
                    ...
                    <div class="padding40 bg-color-3">
                        ...
                        <a href="air-conditioning" class="btn-main btn-light-trans" >Read more</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInRight" data-wow-delay=".2s">
                <div class="rounded-20px overflow-hidden">
                    <div class="padding40 bg-color-3">
                        ...
                        <div class="spacer-20"></div>
                        <a href="refrigeration" class="btn-main btn-light-trans" >Read more</a>
                    </div>
                    <div class="relative">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInRight" data-wow-delay="0s">
                <div class="rounded-20px overflow-hidden">
                    ...
                    <div class="padding40 bg-color-3">
                        ...
                        <div class="spacer-20"></div>
                        <a  href="it-products" class="btn-main btn-light-trans">Read more</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInRight" data-wow-delay=".4s">
                <div class="rounded-20px overflow-hidden">
                    <div class="padding40 bg-color-3">
                        ...
                        <div class="spacer-20"></div>
                        <a href="office-automation" class="btn-main btn-light-trans" >Read more</a>
                    </div>
                    <div class="relative">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3 text-center">
                ...
                <p class="lead wow fadeInUp">Our customers’ trust inspires us to deliver quality and
                    excellence. See what they say about Aaryan Tradelink</p>
                <div class="spacer-single"></div>
            </div>
        </div>
    </div>
                    ...
                    <div class="de_testi s2">
                        <blockquote>
                            ...
                            <p>"They responded promptly and had a technician at my door in no time. Within a
                                few hours, my AC was back up and running smoothly. I'm incredibly grateful
                                for their quick response and expert repair work."</p>
                            <div class="de-rating-ext">
                                <span class="d-stars">
                                    <i>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <div class="de_testi s2">
                        <blockquote>
                            ...
                            <p>"We have given Annual Maintenance Contracts since last three years for all
                                our Ac's. Excellent service, very economical and reasonable pricing. Aaryan
                                Tradelink Team knows what they are doing. They usually respond quickly to
                                urgent requests. Highly recommend them !!!"</p>
                            <div class="de-rating-ext">
                                <span class="d-stars">
                                    <i>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <div class="de_testi s2">
                        <blockquote>
                            ...
                            <p>"The two technicians who came were incredibly knowledgeable they did a
                                thorough assessment of the site to ensure the cameras were in the best
                                places. The work was very neat and tidy, once everything was installed they
                                took us through the system set up to make sure we knew how to work the
                                system before leaving. Both were very polite and helpful. Would highly
                                recommend Aaryan Tradelink."</p>
                            <div class="de-rating-ext">
                                <span class="d-stars">
                                    <i>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <div class="de_testi s2">
                        <blockquote>
                            ...
                            <p>"We have been working with Aaryan Tradelink for over two years now. They are
                                very professional, responsive, and deliver great quality products as per our
                                requirements. While selecting the vendor, cost-effectiveness and timely
                                delivery were essential evaluation criteria for our office IT supply, and we
                                found Aaryan Tradelink an excellent partner to work with."</p>
                            <div class="de-rating-ext">
                                <span class="d-stars">
                                    <i>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="container">
        ...
        <div class="row gx-5 align-items-center">
            <div class="col-lg-6 mb-sm-20 position-relative">
                <div class="relative p-4 faq-img-wid">
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-12 text-center wow fadeInUp">
                <h2 class="wow fadeInUp" data-wow-delay=".2s">Our Clients</h2>
            </div>
