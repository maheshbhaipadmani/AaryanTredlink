    ...
    <div class="container relative z-index-1000">
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <h1>Air Conditioning Maintenance</h1>
                <ul class="crumb">
                    <li><a href="Home">Home</a></li>
                    <li class="active">Air Conditioning Maintenance</li>
                </ul>
            </div>
            <div class="col-lg-6 text-lg-end">
                <div class="fs-20 fw-600 no-bottom sm-hide">Keep Your AC Running Smoothly with Expert Care
                </div>
            </div>
        </div>
    </div>
...
<section>
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-3">
                <a href="Air-Conditioning" class="bg-color-3 d-block p-3 px-4 rounded-10px mb-3">
                    <h4 class="mb-0">About Us</h4>
                </a>
                <a href="Air-Conditioning-Repair" class="bg-color-3 d-block p-3 px-4 rounded-10px mb-3">
            ...
            <div class="col-lg-9">
                <div class="row g-4">
                    <div class="col-lg-12">
                        <h2>Your Trusted Partner for <span class="id-color-2">Air Conditioner</span>
                            Maintenance</h2>
                    </div>
                    <div class="col-lg-12">
