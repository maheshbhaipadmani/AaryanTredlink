                ...
                <div class="container relative z-index-1000">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <h1>IT Products Maintenance</h1>
                            <ul class="crumb">
                                <li><a href="Home">Home</a></li>
                                <li class="active">IT Products Maintenance</li>
                            </ul>
                        </div>
                        <div class="col-lg-6 text-lg-end">
                            <div class="fs-20 fw-600 no-bottom sm-hide">Trusted IT Maintenance for Peak Performance
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row g-5">
                        <div class="col-lg-3">
                            ...
                            <a href="It-Products-Maintenance" class="bg-color-2 text-light d-block p-3 px-4 rounded-10px mb-3 relative">
                        ...
                        <div class="col-lg-9">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <h2>Your trusted partner for <span class="id-color-2">IT maintenance</span>,
                                        ensuring top brands perform with reliability and care.</h2>
                                </div>
                                <div class="col-lg-12">
