...
?>
            ...
            <section id="subheader" class="jarallax text-light">
                <img src="images/background/5.webp" class="jarallax-img" alt="background" loading="lazy">
            ...
            <div class="bg-color relative z-index-1000 mt-40 mb40">
                <a href="Contact">
                    <img src="images/svg/phone-calling-svgrepo-com.svg"
                        class="border-white-6 fs-30 bg-color w-80px p-3 mb20 circle absolute abs-center sm-hide" loading="lazy" alt="phone-calling-svgrepo-com">
                </a>
            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="bg-color p-4 py-5 rounded-20px mb-2 text-center">
                                        <div class="bg-color-3 inline-block w-25 p-3 py-4 rounded-10px m-2 wow scaleIn"
                                            data-wow-delay=".0s">
                                            <img src="./images/home/logo/1.virgo.avif" alt="virgo" class="img-fluid" loading="lazy">
                                        </div>
                                        <div class="bg-color-3 inline-block w-25 p-3 py-4 rounded-10px m-2 wow scaleIn"
                                            data-wow-delay=".2s">
