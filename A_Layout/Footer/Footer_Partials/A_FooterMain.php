...
<div id="contactbtn" class="arcontactus-widget arcontactus-message arcu-scale right md active arcuAnimated">
  <div class="arcontactus-message-button no-text" style="background-color: #333" onclick="redirectToWhatsApp()">
    ...
    <div class="callback-state" style="color: #333">
    ...
    <div class="pulsation" style="background-color: #333"></div>
    <div class="pulsation" style="background-color: #333"></div>
  </div>
</div>
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="social-icons mb-sm-30">
                            <a href="https://www.instagram.com/aaryantradelink.ahmedabad?igsh=MWc5NTZ4YjEwY293MA%3D%3D"><i>
                            ...
                            <a href="https://www.facebook.com/aaryantradelink.ahm?rdid=LzLvLMdatzelyUan&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F18z84XxDZe%2F#"><i>
                               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                                </svg>
                            </i></a>
                            <a href="https://www.linkedin.com/company/aaryantradelink/">
                                <i>
                    ...
                    <div class="col-lg-4 col-sm-6 order-lg-2 order-sm-1">
                        <div class="widget">
                            ...
                            <a href="tel:+919099903098" style="text-decoration: none; color: inherit;">
                                +91-9099903098
                            </a>, <a href="tel:+919824000266" style="text-decoration: none; color: inherit;">
                                +91-9824000266
                            </a>
