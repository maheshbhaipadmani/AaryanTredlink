                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-6 relative">
                            <div class="relative z-index-1000">
                                <div class="subtitle mb-3 wow fadeInUp" data-wow-delay=".1s">Who We Are</div>
                                <h1 class="wow fadeInUp" data-wow-delay=".3s">Delivering Excellence Since 2009</h1>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="bg-color-3 p-4 rounded-10 text-center wow fadeInUp"
                                            data-wow-delay=".5s">
                        ...
                        <div class="col-lg-6">
                            <div class="relative">
                                <div class="row g-4">
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex rounded-5 align-items-center justify-content-center h-100 p-4 bg-color text-light wow scaleIn"
                                            data-wow-delay=".8s">
            ...
            <section id="subheader">
                <div class="container relative z-index-1000">
                    <div class="row g-4 gx-5">
                        ...
                        <div class="col-lg-6">
                            <div class="subtitle s2 bg-color text-light wow fadeInUp mb-2">What We Offer</div>
                            <h1>Delivering Excellence Across Industries</h1>
